...
//            while(searchClient2.lock) {}
            ...
            SearchServer.exec("echo \"Author name searched is " + name + "\"" + " >> hw2-q1.log");
            SearchServer.exec("echo \"The total number is " + sum + "\"" + " >> hw2-q1.log");
            SearchServer.exec("echo \"Time cost " + timeCost + "ms\"" + " >> hw2-q1.log");
        }
